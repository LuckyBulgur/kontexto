 ...
 *
 * Auf schmalen Viewports steht der Hinweis höher, weil er dort fast die volle
 * Breite einnimmt und sonst den Feedback-Knopf unten rechts verdecken würde.
 */
export default function EventBanner() {
  ...
  return (
    <m.div
      ...
      role="status"
      aria-live="polite"
      className="fixed inset-x-0 bottom-20 sm:bottom-3 z-40 mx-auto flex w-[min(92%,30rem)] items-center gap-3 rounded-xl border bg-card px-4 py-3 shadow-lg"
