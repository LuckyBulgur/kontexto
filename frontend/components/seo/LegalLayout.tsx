...
export default function TextPage({ title, breadcrumbName, path, children }: { title: string; breadcrumbName: string; path: string; children: React.ReactNode; }) {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <StructuredData data={breadcrumb([{ name: "Start", path: "/" }, { name: breadcrumbName, path }])} />
