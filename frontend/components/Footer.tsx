...
const socials = [
  {
    ...
    label: "GitHub-Profil des Entwicklers (Ugur Aydoğan)",
  ...
  },
  {
    ...
    label: "LinkedIn-Profil des Entwicklers (Ugur Aydoğan)",
...
export default function Footer() {
  return (
    <footer className="border-t border-border px-4 py-8 text-center text-xs text-muted-foreground">
      ...
      <p className="mt-4">© Kontexto – das deutsche Wort-Ratespiel · entwickelt von Ugur Aydoğan</p>
    </footer>
  );
}
