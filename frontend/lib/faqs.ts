...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    a: `Ein durchsuchbares Archiv aller vergangenen Tageslösungen gibt es bewusst nicht, weil es die Lösung des laufenden Tages zu leicht auffindbar machen würde. Über die Rätselnummer lässt sich ein früheres Rätsel aber gezielt aufrufen. Wer einfach mehr spielen möchte, nimmt den Unendlich-Modus: Er zieht ein zufälliges Rätsel aus dem vorberechneten Bestand von 9.537 Partien, unabhängig vom Datum, und merkt sich, welche du schon gespielt hast. So kannst du üben, so oft du willst, ohne dass die Tageslösung dabei irgendwo nachschlagbar wird.`,
  },
  {
    q: `Ist Kontexto kostenlos? Gibt es Werbung?`,
    a: `Das Spiel ist vollständig kostenlos, es gibt keine Bezahlschranke, keinen Abo-Bereich und keine Funktion, die hinter einer Zahlung liegt. Finanziert wird es über Werbung, übergangsweise von Adcash, später von Google AdSense. Anzeigen laufen ausschließlich auf den Spielseiten, allein wie zu mehreren, und nur, wenn du sie im Einwilligungsbanner erlaubt hast. Inhaltsseiten, Rechtsseiten und der Stream-Modus bleiben werbefrei. Tracking- und Werbe-Cookies werden erst gesetzt, wenn du eingewilligt hast, und die Einwilligung lässt sich über den Link in der Fußzeile jederzeit ändern oder widerrufen. Ohne Einwilligung läuft das Spiel unverändert weiter.`,
  },
  {
