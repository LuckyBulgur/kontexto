...
- Analytics: `collect/token`, `collect` (pageview), `stats/complete` (client completion histograms), `survey/answer` (attribution survey, one answer per fingerprint).
